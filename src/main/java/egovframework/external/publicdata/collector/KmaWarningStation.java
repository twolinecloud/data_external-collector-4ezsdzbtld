 ...
 *
 * <p>{@code egovframework.external.rule} 패키지에서 규칙 평가용으로 만들어졌다가,
 * {@code KmaWeatherWarningListCleanser}(정제 단계)도 같은 매칭이 필요해져서
 * {@code publicdata.collector}로 옮김(2026-08-21) - {@link FacilityRegionLoader}와
 * 같은 위치에 두는 게 일관적이라 판단.</p>
 *
